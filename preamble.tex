...
\usepackage{tikz}
\usepackage{cancel}
\usetikzlibrary{angles, quotes, arrows.meta, positioning, calc, bending}
...
\theoremstyle{nodot}
\newtheorem*{theorem}{Теорема \\ \indent}
\newtheorem*{theorem*}{Теорема}
\newtheorem*{lemma*}{Лемма}
\newtheorem*{lemma}{Лемма \\ \indent}
\newtheorem*{definition}{Опр.\\ \indent}
\newtheorem*{statement}{Утв. \\ \indent}
\newtheorem*{statement*}{Утв.}
\newtheorem*{consequence}{Следствие \\ \indent}
\newtheorem*{consequence*}{Следствие}
\newtheorem*{example}{Пример \\ \indent}
\newtheorem*{example*}{Пример}
\newtheorem*{remark}{Замечание \\ \indent}
\newtheorem*{remark*}{Замечание}
\newtheorem*{solve}{Решение \\ \indent}
...
\newcommand{\Res}{\mathop{\operatorname{Res}}\limits}
...
\renewcommand{\iff}{\;\xLeftrightarrow{\hspace{0.25cm}}\;}
